...
type Documents = {
    ...
    "mutation DeleteFolderPermission($id: UUID!) {\n  folderPermission {\n    delete(permissionId: $id) {\n      success\n      message\n    }\n  }\n}": typeof types.DeleteFolderPermissionDocument,
    ...
    "mutation RenameFolder($folderId: UUID!, $input: FolderUpdateInput!) {\n  folder {\n    update(id: $folderId, input: $input) {\n      id\n      name\n      updatedAt\n    }\n  }\n}": typeof types.RenameFolderDocument,
...
const documents: Documents = {
    ...
    "mutation DeleteFolderPermission($id: UUID!) {\n  folderPermission {\n    delete(permissionId: $id) {\n      success\n      message\n    }\n  }\n}": types.DeleteFolderPermissionDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation DeleteFolderPermission($id: UUID!) {\n  folderPermission {\n    delete(permissionId: $id) {\n      success\n      message\n    }\n  }\n}"): (typeof documents)["mutation DeleteFolderPermission($id: UUID!) {\n  folderPermission {\n    delete(permissionId: $id) {\n      success\n      message\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation moveFile($id: UUID!, $folderId: UUID!) {\n  file {\n    update(id: $id, input: {folderId: $folderId}) {\n      id\n      name\n      folder {\n        id\n      }\n    }\n  }\n}"): (typeof documents)["mutation moveFile($id: UUID!, $folderId: UUID!) {\n  file {\n    update(id: $id, input: {folderId: $folderId}) {\n      id\n      name\n      folder {\n        id\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation moveFolder($id: UUID!, $parentId: UUID!) {\n  folder {\n    update(id: $id, input: {parentId: $parentId}) {\n      id\n      name\n      parent {\n        id\n      }\n    }\n  }\n}"): (typeof documents)["mutation moveFolder($id: UUID!, $parentId: UUID!) {\n  folder {\n    update(id: $id, input: {parentId: $parentId}) {\n      id\n      name\n      parent {\n        id\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation RenameFolder($folderId: UUID!, $input: FolderUpdateInput!) {\n  folder {\n    update(id: $folderId, input: $input) {\n      id\n      name\n      updatedAt\n    }\n  }\n}"): (typeof documents)["mutation RenameFolder($folderId: UUID!, $input: FolderUpdateInput!) {\n  folder {\n    update(id: $folderId, input: $input) {\n      id\n      name\n      updatedAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
